 ...
 * Helper functions
 *
 * @package     SimpleAttribution\Functions
 * @since       2.0.0
 */
...
/**
 * Build an array of valid post types
 *
 * @since       2.0.0
 * @return      array $post_types The valid post types
 */
function simple_attribution_get_post_types() {
	$post_types = array();
	$valid      = get_post_types( array( 'public' => true ), 'objects' );

	foreach ( $valid as $post_type ) {
